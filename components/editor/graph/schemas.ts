...
export const arrowModeSchema = z.union([
  z.literal("NONE"),
  z.literal("POSITIVE"),
  z.literal("BOTH"),
]);
...
export const lineStyleSchema = z.union([
  z.literal("SOLID"),
  z.literal("DASHED"),
  z.literal("DOTTED"),
]);

export const pointStyleSchema = z.union([
  z.literal("POINT"),
  z.literal("OPEN"),
  z.literal("CROSS"),
]);
...
export const labelSizeSchema = z.union([
  z.literal("SMALL"),
  z.literal("MEDIUM"),
  z.literal("LARGE"),
  latexSchema,
