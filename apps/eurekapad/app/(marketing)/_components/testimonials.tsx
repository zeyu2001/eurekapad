...
export default function Testimonials() {
  return (
    <div className="relative isolate bg-white pb-32 pt-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <Card className="col-span-2 hidden sm:block rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
            <CardContent className="p-12">
              <blockquote className="text-xl font-semibold leading-8 tracking-tight text-gray-900">
                <p>{`"${featuredTestimonial.body}"`}</p>
              </blockquote>
            </CardContent>
            <CardFooter className="flex items-center gap-x-4 border-t border-gray-900/10 px-6 py-4">
                ...
                >
                  {column.map(testimonial => (
                    ...
                    >
                      ...
                      <CardFooter className="mt-6 flex items-center gap-x-4">
                        <Image
                          src={testimonial.author.logoUrl || '/placeholder.svg'}
                          alt=""
                          width={40}
                          height={40}
