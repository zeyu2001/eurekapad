...
export default function CTA() {
  return (
    <section className="relative pt-20 pb-24 lg:pt-28 lg:pb-32 bg-blue-600">
      <div className="absolute top-0 left-0 w-full overflow-hidden -translate-y-full">
        <div className="relative h-8">
          <div className="absolute bottom-0 w-full h-full bg-blue-600 rounded-t-[24px]" />
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-xl leading-relaxed text-accent-100">
            Join thousands of STEM professionals and students who&apos;ve transformed their workflow with EurekaPad.
          </p>
          <div className="mt-12 flex flex-col items-center justify-center gap-4">
            {/* <Link href="/signup">
              <Button
                size="lg"
                variant="secondary"
                className="rounded-lg bg-white px-8 py-3 text-base font-medium text-blue-600 shadow-lg hover:bg-blue-50 transition-colors"
              >
                Get Started for Free
              </Button>
            </Link> */}
            ...
            <p className="mt-4 text-sm text-accent-200">No credit card required • Free forever plan available</p>
          </div>
        </div>
      </div>
    </section>
